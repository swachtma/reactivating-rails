...
In the final chapter, we clean up our code with an application-wide refactor.  We look for opportunities to clarify our code's intent, expand test coverage, and to optimize render times. 
