...
Now let's build a footer chapter link to demonstrate the reusability of our new HOC, and improve our UX as well.  First though, when I told you that Redux-First-Router was modularized, I was not kidding.  To create a link using the provided link helper we need to install that module: `docker-compose exec client yarn add redux-first-router-link`.
